                            ...
                            return (
                                <li key={assunto.id}>
                                    ...
                                    <section style={{display: 'flex', gap: '1em'}}>
                                        <BotaorCard onClick={(e) => capturaCliqueBotaoUsuario(e)} $type="excluir" name="excluir_assunto">
                                            Excluir Assunto
                                        </BotaorCard>
                                        <BotaorCard $type="editar" onClick={(e) => capturaCliqueBotaoUsuario(e)} name="editar_assunto">
                                            Editar Assunto
                                        </BotaorCard>
                                    </section>
                                </li>
